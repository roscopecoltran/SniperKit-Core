...
hunter_config(Eigen VERSION 3.3.1-p4 CMAKE_ARGS "BUILD_TESTING=OFF" "HUNTER_INSTALL_LICENSE_FILES=COPYING.MPL2" "CMAKE_Fortran_COMPILER=OFF")
...
hunter_config(OpenCV VERSION 3.3.0-p1 CMAKE_ARGS "BUILD_DOCS=OFF" "BUILD_TESTS=OFF" "BUILD_PERF_TESTS=OFF" "BUILD_opencv_apps=OFF" "BUILD_EXAMPLES=OFF" "ENABLE_NEON=OFF" "BUILD_ANDROID_SERVICE=OFF" "BUILD_ANDROID_EXAMPLES=OFF" "BUILD_ZLIB=OFF" "BUILD_TIFF=OFF" "BUILD_PNG=OFF" "BUILD_JPEG=OFF" "ANDROID_EXAMPLES_WITH_LIBS=OFF" "WITH_PNG=ON" "WITH_TIFF=OFF" "WITH_JASPER=ON" "WITH_JPEG=ON" "WITH_OPENCL=NO" "HAVE_OPENCL=NO" "HAVE_EIGEN=NO" "HAVE_CUFFT=NO" "HAVE_CUBLAS=NO" "HAVE_CUDA=NO" "WITH_QTKIT=NO" "WITH_PTHREADS_PF=OFF" "WITH_TBB=OFF" "WITH_1394=OFF" "WITH_AVFOUNDATION=OFF" "WITH_CARBON=OFF" "WITH_VTK=OFF" "WITH_CUDA=OFF" "WITH_CUFFT=OFF" "WITH_CUBLAS=OFF" "WITH_NVCUVID=OFF" "WITH_EIGEN=OFF" "WITH_VFW=OFF" "WITH_FFMPEG=OFF" "WITH_GSTREAMER=OFF" "WITH_GSTREAMER_0_10=OFF" "WITH_GTK=OFF" "WITH_GTK_2_X=OFF" "WITH_IPP=OFF" "WITH_WEBP=OFF" "WITH_OPENEXR=OFF" "WITH_OPENGL=OFF" "WITH_OPENNI=OFF" "WITH_OPENNI2=OFF" "WITH_PVAPI=OFF" "WITH_GIGEAPI=OFF" "WITH_QT=OFF" "WITH_WIN32UI=OFF" "WITH_QUICKTIME=OFF" "WITH_OPENMP=OFF" "WITH_CSTRIPES=OFF" "WITH_UNICAP=OFF" "WITH_V4L=OFF" "WITH_LIBV4L=OFF" "WITH_DSHOW=OFF" "WITH_MSMF=OFF" "WITH_XIMEA=OFF" "WITH_XINE=OFF" "WITH_CLP=OFF" "WITH_OPENCL=OFF" "WITH_OPENCL_SVM=OFF" "WITH_OPENCLAMDFFT=OFF" "WITH_OPENCLAMDBLAS=OFF" "WITH_DIRECTX=OFF" "WITH_INTELPERC=OFF" "WITH_IPP_A=OFF" "WITH_GDAL=OFF" "WITH_GPHOTO2=OFF" "BUILD_opencv_world=ON" "BUILD_opencv_world_contrib=ON" "BUILD_opencv_ts=OFF" "BUILD_opencv_python2=OFF" "BUILD_opencv_shape=OFF" "BUILD_opencv_superres=OFF" "HAVE_OPENCL=OFF" "WITH_OPENCL=OFF" "BUILD_EIGEN=OFF" "BUILD_SHARED_LIBS=OFF" "OPENCV_WITH_EXTRA_MODULES=ON" "BUILD_opencv_dnn=OFF" "BUILD_opencv_xobjdetect=OFF")
...
hunter_config(aglet VERSION 1.2.0 CMAKE_ARGS "AGLET_OPENGL_ES3=OFF")
...
hunter_config(dlib VERSION 19.4-p2 CMAKE_ARGS "DLIB_HEADER_ONLY=OFF" "DLIB_ENABLE_ASSERTS=OFF" "HUNTER_INSTALL_LICENSE_FILES=dlib/LICENSE.txt" "DLIB_USE_CUDA=OFF" "DLIB_GIF_SUPPORT=OFF" "DLIB_USE_MKL_FFT=OFF" "DLIB_LINK_WITH_SQLITE3=OFF")
...
hunter_config(ogles_gpgpu VERSION 0.2.1 CMAKE_ARGS "OGLES_GPGPU_VERBOSE=OFF" "OGLES_GPGPU_OPENGL_ES3=OFF")
...
hunter_config(xgboost VERSION 0.40-p9 CMAKE_ARGS "XGBOOST_USE_CEREAL=ON" "XGBOOST_USE_HALF=ON" "XGBOOST_DO_LEAN=ON")
