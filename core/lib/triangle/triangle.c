...
#define decode(ptr, otri)                                                     \
  (otri).orient = (int) ((POINTER_TYPE) (ptr) & (POINTER_TYPE) 3l);         \
  (otri).tri = (triangle *)                                                   \
                  ((POINTER_TYPE) (ptr) ^ (POINTER_TYPE) (otri).orient)
...
#define encode(otri)                                                          \
  (triangle) ((POINTER_TYPE) (otri).tri | (POINTER_TYPE) (otri).orient)
...
#define infect(otri)                                                          \
  (otri).tri[6] = (triangle)                                                  \
                    ((POINTER_TYPE) (otri).tri[6] | (POINTER_TYPE) 2l)
...
#define infected(otri)                                                        \
  (((POINTER_TYPE) (otri).tri[6] & (POINTER_TYPE) 2l) != 0l)
...
#define sdecode(sptr, osub)                                                   \
  (osub).ssorient = (int) ((POINTER_TYPE) (sptr) & (POINTER_TYPE) 1l);      \
  (osub).ss = (subseg *)                                                      \
              ((POINTER_TYPE) (sptr) & ~ (POINTER_TYPE) 3l)
...
#define sencode(osub)                                                         \
  (subseg) ((POINTER_TYPE) (osub).ss | (POINTER_TYPE) (osub).ssorient)
...

{
  ...
  if (printvertex == (vertex) NULL)
    ...
    printf("    Origin[%d] = x%lx  (%.12g, %.12g)\n",
           (t->orient + 1) % 3 + 3, (POINTER_TYPE) printvertex,
  ...
  if (printvertex == (vertex) NULL)
    ...
    printf("    Dest  [%d] = x%lx  (%.12g, %.12g)\n",
           (t->orient + 2) % 3 + 3, (POINTER_TYPE) printvertex,
           printvertex[0], printvertex[1]);
  apex(*t, printvertex);
  if (printvertex == (vertex) NULL)
    printf("    Apex  [%d] = NULL\n", t->orient + 3);
    ...
    printf("    Apex  [%d] = x%lx  (%.12g, %.12g)\n",
           t->orient + 3, (POINTER_TYPE) printvertex,
           printvertex[0], printvertex[1]);

  if (b->usesegments) {
    sdecode(t->tri[6], printsh);
    if (printsh.ss != m->dummysub) {
      printf("    [6] = x%lx  %d\n", (POINTER_TYPE) printsh.ss,
             printsh.ssorient);
    }
...

{
  ...
  printf("subsegment x%lx with orientation %d and mark %d:\n",
         (POINTER_TYPE) s->ss, s->ssorient, mark(*s));
  ...
  if (printvertex == (vertex) NULL)
    ...
    printf("    Origin[%d] = x%lx  (%.12g, %.12g)\n",
           2 + s->ssorient, (POINTER_TYPE) printvertex,
           printvertex[0], printvertex[1]);
  sdest(*s, printvertex);
  if (printvertex == (vertex) NULL)
    printf("    Dest  [%d] = NULL\n", 3 - s->ssorient);
    ...
    printf("    Dest  [%d] = x%lx  (%.12g, %.12g)\n",
           3 - s->ssorient, (POINTER_TYPE) printvertex,
           printvertex[0], printvertex[1]);
  ...
  if (printvertex == (vertex) NULL)
    ...
    printf("    Segment origin[%d] = x%lx  (%.12g, %.12g)\n",
           4 + s->ssorient, (POINTER_TYPE) printvertex,
           printvertex[0], printvertex[1]);
...

{
  ...
  alignptr = (POINTER_TYPE)(pool->nowblock + 1);
  /* Align the item on an `alignbytes'-byte boundary. */
  pool->nextitem = (VOID *)
    (alignptr + (POINTER_TYPE) pool->alignbytes -
    (alignptr % (POINTER_TYPE)pool->alignbytes));
...

{
  ...
  alignptr = (POINTER_TYPE)(pool->pathblock + 1);
...

{
  ...
  alignptr = (POINTER_TYPE)m->dummytribase;
  m->dummytri = (triangle *)
    (alignptr + (POINTER_TYPE) m->triangles.alignbytes -
    (alignptr % (POINTER_TYPE) m->triangles.alignbytes));
  ...
  if (b->usesegments) {
    ...
    alignptr = (POINTER_TYPE) m->dummysubbase;
    m->dummysub = (subseg *)
        (alignptr + (POINTER_TYPE) m->subsegs.alignbytes -
        (alignptr % (POINTER_TYPE) m->subsegs.alignbytes));
...

{
  ...
  alignptr = (POINTER_TYPE) (getblock + 1);
  foundvertex = (char *) (alignptr + (POINTER_TYPE) m->vertices.alignbytes -
                         (alignptr % (POINTER_TYPE) m->vertices.alignbytes));
...

{
  ...
  while (totalsamplesleft > 0) {
    ...
    alignptr = (POINTER_TYPE)(sampleblock + 1);
    firsttri = (char *) (alignptr +
                         (POINTER_TYPE) m->triangles.alignbytes -
                         (alignptr %
                         (POINTER_TYPE) m->triangles.alignbytes));
